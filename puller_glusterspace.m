function workpath=puller_glusterspace(runno,datapath,scanner,overwrite)
...
workpath = ['/glusterspace/Russell/' runno];
...
fid_pull_cmd=['sshpass -p ' pw ' scp omega@' scanner ':' datapath '/fid ' workpath '/' runno '.fid'];
procpar_pull_cmd=['sshpass -p ' pw ' scp omega@' scanner ':' datapath '/procpar ' workpath '/' runno '.procpar'];
