function  [mag,phs,raw,kraw,iraw] = MapME3(orientation,brainextract,idxstart)
...
echoshift = [-1 0 0]; %pixel shift of max to aid in registration
xform = 'even2odd.mat';
...
for ipfile = 1:num_pfile
    ...
    if ipfile == 1
        ...
        echo_spacing = hdr.rdb.user33/1e6;
    end
