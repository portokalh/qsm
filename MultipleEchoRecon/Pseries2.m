function  [raw] = Pseries2(varargin)
...
echoshift = [-2 0 0];   % Use for correcting even echo pixel shift (bad way)
for narg = 1:nargin
...
if dim4 > 1
    ...
    % Correct phase/pixel shift in even echoes
    fprintf('   Performing phase correction on even echoes (coming soon)...\n');
